        ...
        <div className="bg-white dark:bg-gray-800 shadow-xl rounded-lg px-8 pt-8 pb-8 animate-fade-in">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="text-xs text-gray-600 dark:text-gray-300 space-y-1">
              <div><strong>Residente:</strong> residente@example.com / password123</div>
              <div><strong>Administrador:</strong> admin@example.com / password123</div>
              <div><strong>Conserje:</strong> conserje@example.com / password123</div>
            </div>
          </div>
        </div>
      </div>
